//base de datos local de preguntas con un arreglo
const bd__juego = [
    {
        id: 0,
...
let respuestas = [];//Guardar respuestas elegidas
let cantidadCorrectas = 0;//Correctas
let numPregunta = 0;//pregunta actual que debe ser cargada

//Cargo una pregunta
function cargarPreguntas() {
    //tomo la pregunta actual de la bd__juego
    const pregunta = bd__juego[numPregunta];
    //esto es para crear un div como el que tengo en html...nótese que hay un solo div!!
    ...
    //Esto va a la section del HTML y agrega el div con todo
...
//Uso un for para cargar las preguntas
...
function seleccionar(pos, opElegida) {
    //Se guardan todas las respuestas en un array
